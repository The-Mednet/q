-- Migration script for adding recipient tracking tables
-- Run this script to add recipient tracking to existing relay database

USE relay;

-- Check if recipients table already exists, if not create it
...
SELECT 'Recipient tracking tables created successfully!' as result;